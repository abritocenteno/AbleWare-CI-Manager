 ...
 * @author abel
 */
public class BulkTableModelSearch {
    ...
    public BulkTableModelSearch(String ID,String Artikelcode,  String Locatie, String Aantal, String Omschrijving, String Eenheid, String Initiaal,String Datum, String Le) {
        this.ID = ID;
        this.Aantal = Aantal;
